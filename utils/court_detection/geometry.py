...
def mask_free_throw_lines(frame, corners):
    h, w = frame.shape[:2]

    mask = np.zeros((h, w))
    cv2.line(mask, corner_2_tuple(corners['P4']), corner_2_tuple(corners['P5']), 255, 5)
    cv2.line(mask, corner_2_tuple(corners['P12']), corner_2_tuple(corners['P13']), 255, 5)
